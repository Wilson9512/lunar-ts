...
function getTermDay(year: number, termIndex: number): number | null {
  ...
  const calDay = [
    info[0].slice(0, 1), info[0].slice(1, 3), info[0].slice(3, 4), info[0].slice(4, 6),
    info[1].slice(0, 1), info[1].slice(1, 3), info[1].slice(3, 4), info[1].slice(4, 6),
    info[2].slice(0, 1), info[2].slice(1, 3), info[2].slice(3, 4), info[2].slice(4, 6),
    info[3].slice(0, 1), info[3].slice(1, 3), info[3].slice(3, 4), info[3].slice(4, 6),
    info[4].slice(0, 1), info[4].slice(1, 3), info[4].slice(3, 4), info[4].slice(4, 6),
    info[5].slice(0, 1), info[5].slice(1, 3), info[5].slice(3, 4), info[5].slice(4, 6)
  ];
